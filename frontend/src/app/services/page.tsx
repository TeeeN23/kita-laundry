...
const howWeWorkSteps = [
  {
    ...
    description:
      "Use our app or website to schedule a pickup at your convenient time.",
    features: [
      "Easy online booking",
      "Flexible time slots",
  ...
  },
  {
    ...
    description:
      "Our trained delivery partner arrives at your doorstep to collect your laundry.",
    features: [
  ...
  },
  {
    ...
    description:
      "Your clothes are cleaned with premium eco-friendly detergents by trained experts.",
    features: [
    ...
    image:
      "https://images.unsplash.com/photo-1517677208171-0bc6725a3e60?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  },
  {
    id: 4,
    title: "Delivery",
    ...
    description:
      "Your fresh, clean clothes are delivered back to your doorstep right on time.",
    features: [
      "On-time delivery",
      "Neatly packed",
      "Quality check",
...
const faqData = [
  {
    ...
    answer:
      "We clean all types of garments including everyday wear, formal clothes, delicates, woolens, silks, sarees, suits, curtains, bed sheets, and more.",
  },
  {
    question: "How do you handle delicate fabrics?",
    answer:
      "Delicate fabrics like silk, wool, and cashmere receive special attention with gentle, fabric-specific detergents and appropriate cleaning methods.",
  },
  {
    question: "What is the difference between Wash & Fold and Dry Cleaning?",
    answer:
      "Wash & Fold is regular water-based washing for everyday clothes. Dry Cleaning uses special solvents for delicate fabrics and formal wear.",
  },
  {
    question: "Can you remove tough stains?",
    answer:
      "Yes! Our expert technicians specialize in stain removal including oil, ink, wine, coffee, and food stains.",
  },
  {
    question: "How long does the service take?",
    answer:
      "Standard service takes 24-48 hours. Express service is available for same-day or next-day delivery.",
  },
  {
    question: "Do you provide packaging for delivered clothes?",
    answer:
      "Yes, all cleaned garments are carefully packed. Formal wear is delivered on hangers with protective covers.",
  },
];
...
function FAQItem({
  ...
  return (
    <div className="overflow-hidden">
      <button
        onClick={onToggle}
        className={`w-full px-8 py-5 text-left flex items-center justify-between transition-colors duration-200 ${isOpen ? "bg-teal-500" : "bg-slate-700 hover:bg-slate-600"}`}
      >
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (
        ...
        sectionRect.bottom > stickyEndPoint
      ) {
        setIsSticky(true);
        setStickyEnd(false);
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 text-sm sm:text-base">
              Getting your laundry done has never been easier. Just 4 simple
              steps!
            </p>
          </div>
                ...
                <div className="absolute right-4 top-1/2 -translate-y-1/2 flex flex-col space-y-2 z-20">
                  {howWeWorkSteps.map((_, index) => (
                    <button
                      ...
                      className={`w-3 h-10 rounded-full transition-all duration-300 ${activeStep === index ? "bg-teal-500" : "bg-white/50 hover:bg-white/70"}`}
                    />
                  ))}
                </div>
              </div>
          ...
          <div ref={contentRef} className="w-1/2">
            {howWeWorkSteps.map((step, index) => (
              <div
                ...
                className="min-h-[400px] flex items-center py-8 first:pt-0"
              >
                <div className="w-full">
                  <div className="flex items-center space-x-4 mb-6">
                    <div
                      className={`w-14 h-14 rounded-full flex items-center justify-center transition-colors duration-300 ${activeStep === index ? "bg-teal-500" : "bg-gray-300"}`}
                    >
                      <span className="text-xl font-bold text-white">
                        {step.id}
                      </span>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              From everyday laundry to premium dry cleaning, we offer
              comprehensive garment care solutions.
            </p>
          </div>
            ...
            {services.map((service) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-sm font-bold text-teal-600 mb-3">
                    {service.price}
                  </p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Doorstep service at no extra cost
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-teal-100 rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Got questions about our services? We have got answers.
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-teal-500 to-cyan-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Button
              size="lg"
              className="bg-white/20 border-2 border-white text-white hover:bg-white hover:text-teal-600"
            >
              <Phone className="w-5 h-5 mr-2" />
              Call Us
            </Button>
