  ...
  const testimonials = [
    {
      ...
      name: "Divya K.",
      review:
        "I gave them my silk saree and was honestly worried. But they handled it with such care. Impressive service and safe for delicate fabrics!",
      rating: 5,
    },
    {
      id: 2,
      name: "Rajat T.",
      review:
        "Very smooth process — booked on the app, got a confirmation instantly, and pickup arrived right on time. Great for busy people like me.",
      rating: 5,
    },
    {
      id: 3,
      name: "Tanvi M.",
      review:
        "Affordable prices and great quality. Clothes were perfectly ironed and smelled so fresh. 10/10 for service!",
      rating: 5,
    },
    {
      id: 4,
      name: "Karan V.",
      review:
        "This is my third time using Kita Laundry and I'm never going back to hand washing or dry cleaning shops. So easy and dependable!",
      rating: 5,
    },
    {
      id: 5,
      name: "Priya S.",
      review:
        "Best laundry service in the city! My curtains came back looking brand new. Will definitely recommend to friends and family.",
      rating: 5,
    },
    {
      id: 6,
      name: "Amit R.",
      review:
        "The pickup and delivery is so convenient. No more weekend trips to the dry cleaner. Excellent quality every single time!",
      rating: 5,
    },
    {
      id: 7,
      name: "Sneha P.",
      review:
        "I was skeptical at first but the quality exceeded my expectations. My formal suits look professionally cleaned. Highly recommended!",
      rating: 5,
    },
    {
      id: 8,
      name: "Vikram J.",
      review:
        "Fast, reliable, and affordable. The customer support is also very responsive. Been using for 6 months now, never disappointed.",
      rating: 5,
    },
  ];
...
function ScrollBannerSection({
  isAuthenticated,
  onGalleryVisible,
}: {
  isAuthenticated: boolean;
  onGalleryVisible?: (visible: boolean) => void;
}) {
  ...
  return (
    <div
      ref={sectionRef}
      className="relative"
      style={{ minHeight: isPinned ? "200vh" : "auto" }}
    >
              ...
              <>
                <div
                  ...
                  style={{
                    ...
                    opacity:
                      scrollProgress > 0.5 ? 1 : (scrollProgress - 0.3) * 5,
                  }}
                />
                <div
      ...
      {showGallery && (
        ...
        >
          ...
          <div className="mb-4 overflow-hidden">
            ...
            >
              {[...topRowImages, ...topRowImages, ...topRowImages].map(
                (img, index) => (
                  <div
                    key={`top-${index}`}
          ...
          <div className="overflow-hidden">
            ...
            >
              {[...bottomRowImages, ...bottomRowImages, ...bottomRowImages].map(
                (img, index) => (
                  <div
                    key={`bottom-${index}`}
                    className="w-72 h-48 flex-shrink-0 rounded-xl overflow-hidden"
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  Every order is backed by our industry-leading guarantee. If
                  you're not satisfied with the cleaning of your clothes, we
                  will re-clean them – free of charge.
                </p>
              </div>
            </div>
          </div>
...
export default function HomePage() {
  ...
  return (
    <div
      className={`min-h-screen transition-colors duration-500 ${isDarkTheme ? "bg-gray-900" : "bg-white"}`}
    >
      {/* Booking Modal */}
      <BookingModal
      ...
      {/* Navigation - Fixed */}
      <nav
        className={`shadow-sm border-b fixed top-0 left-0 right-0 z-50 transition-colors duration-500 ${isDarkTheme ? "bg-gray-900 border-gray-700" : "bg-white border-gray-200"}`}
      >
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span
                className={`text-2xl font-bold transition-colors duration-500 ${isDarkTheme ? "text-white" : "text-gray-800"}`}
              >
                Kita Laundry
              </span>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link
                href="/"
                className={`transition-colors duration-500 ${isDarkTheme ? "text-gray-300 hover:text-teal-400" : "text-gray-600 hover:text-teal-500"}`}
              >
                Home
              </Link>
              <Link
              ...
              {isAuthenticated ? (
                <div className="flex items-center space-x-4">
                  ...
                  <div className="relative group">
                    <button
                      className={`flex items-center space-x-2 py-2 transition-colors duration-500 ${isDarkTheme ? "text-gray-300 hover:text-teal-400" : "text-gray-700 hover:text-teal-500"}`}
                    >
                ...
                <div className="flex items-center space-x-3">
                  <Link href="/auth/login">
                    <Button
                      variant="outline"
                      className={`transition-colors duration-500 ${isDarkTheme ? "border-teal-400 text-teal-400 hover:bg-teal-400/10" : "border-teal-500 text-teal-600 hover:bg-teal-50"}`}
                    >
                      Login
                    </Button>
                  </Link>
          ...
          {mobileMenuOpen && (
            <div
              className={`md:hidden border-t mt-4 pt-4 pb-2 transition-colors duration-500 ${isDarkTheme ? "border-gray-700" : "border-gray-200"}`}
            >
              <div className="flex flex-col space-y-3">
                <Link
                  href="/"
                  className={`py-2 transition-colors duration-500 ${isDarkTheme ? "text-gray-300 hover:text-teal-400" : "text-gray-600 hover:text-teal-500"}`}
                ...
                {isAuthenticated ? (
                  <>
                    <hr
                      className={`my-2 transition-colors duration-500 ${isDarkTheme ? "border-gray-700" : "border-gray-200"}`}
                    />
                    <Link
                      href="/customer/dashboard"
                      className={`py-2 transition-colors duration-500 ${isDarkTheme ? "text-gray-300 hover:text-teal-400" : "text-gray-600 hover:text-teal-500"}`}
                  ...
                  <div className="flex flex-col space-y-2 pt-2">
                    ...
                    >
                      <Button
                        variant="outline"
                        className={`w-full transition-colors duration-500 ${isDarkTheme ? "border-teal-400 text-teal-400 hover:bg-teal-400/10" : "border-teal-500 text-teal-600 hover:bg-teal-50"}`}
                      >
                        Login
                      </Button>
                    </Link>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-gray-800 mb-4">
              We Collect, Clean, and Deliver Your
              <br />
              Laundry & Dry Cleaning
            </h2>
            <p className="text-gray-800 font-semibold max-w-3xl mx-auto">
              At Kita Laundry, we offer a seamless laundry and dry cleaning
              experience tailored to your busy lifestyle. From pickup to
              delivery, every step is handled with professionalism and care.
            </p>
          </div>
              ...
              <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 group-hover:-translate-y-1 border border-gray-100">
                ...
                <div className="p-5 pt-4">
                  ...
                  <p className="text-gray-800 font-medium text-sm">
                    Place your laundry request in just a few clicks.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="text-center group">
              ...
              <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 group-hover:-translate-y-1 border border-gray-100">
                ...
                <div className="p-5 pt-4">
                  ...
                  <p className="text-gray-800 font-medium text-sm">
                    We collect your clothes right from your doorstep.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="text-center group">
              ...
              <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 group-hover:-translate-y-1 border border-gray-100">
                ...
                <div className="p-5 pt-4">
                  ...
                  <p className="text-gray-800 font-medium text-sm">
                    Expert care with advanced cleaning technology.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="text-center group">
              ...
              <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 group-hover:-translate-y-1 border border-gray-100">
                ...
                <div className="p-5 pt-4">
                  ...
                  <p className="text-gray-800 font-medium text-sm">
                    Fresh, clean clothes delivered back to you on time.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative rounded-2xl overflow-hidden min-h-[450px]">
              ...
              <div className="relative z-10 p-8 h-full flex flex-col justify-center">
                ...
                <p className="text-gray-200 text-lg mb-4">
                  Join over 50,000+ satisfied customers who trust Kita Laundry
                  with their laundry needs every day.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <Button
                    size="lg"
                    className="bg-green-500 hover:bg-green-600 text-white w-full sm:w-auto shadow-lg"
                  >
                    <Phone className="w-5 h-5 mr-2" />
                    Chat on WhatsApp
                  </Button>
      ...
      <section id="services" className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <p className="text-teal-500 font-semibold mb-2">
              Premium Laundry And Dry Clean Service in Medan
            </p>
            <h2 className="text-4xl font-bold text-gray-800 mb-4">
              Quality Cleaning with Great Savings!
            </h2>
            <p className="text-gray-800 font-semibold max-w-4xl mx-auto">
              At Kita Laundry, we take care of all your clothing needs — from
              everyday home wear to formal office attire — ensuring each piece
              is cleaned with expert care. Our services go beyond garments,
              offering shoe cleaning, curtain cleaning, carpet cleaning, and
              more to provide complete home care solutions.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-4 mb-12">
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-300 text-center">
              ...
              <p className="text-gray-600 text-sm mb-4 min-h-[40px]">
                Fresh, clean, neatly folded clothes.
                <br />
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-300 text-center">
              ...
              <p className="text-gray-600 text-sm mb-4 min-h-[40px]">
                Clean, crisp, wrinkle-free garments.
                <br />
                Ready to wear daily.
              </p>
              <Button
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-300 text-center">
              ...
              <p className="text-gray-600 text-sm mb-4 min-h-[40px]">
                Gentle care for special fabrics.
                <br />
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-300 text-center">
              ...
              <p className="text-gray-600 text-sm mb-4 min-h-[40px]">
                Smooth, polished finish with steam.
                <br />
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-300 text-center">
              ...
              <p className="text-gray-600 text-sm mb-4 min-h-[40px]">
                Perfect, lasting stiffness for clothes.
                <br />
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-300 text-center">
              ...
              <p className="text-gray-600 text-sm mb-4 min-h-[40px]">
                Extra-fine, careful press service.
                <br />
      ...
      <section className="py-16 bg-gradient-to-b from-cyan-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <p className="text-teal-500 font-semibold mb-2">
              Best Dry Clean And Laundry Service in Medan
            </p>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-800 font-semibold mb-8 max-w-2xl mx-auto">
            Join thousands of satisfied customers who trust Kita Laundry for
            their laundry and dry cleaning needs.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {isAuthenticated ? (
              <Link href="/customer/orders/new">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-teal-500 to-cyan-600 hover:from-teal-600 hover:to-cyan-700 text-white shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
                >
                  <Truck className="w-5 h-5 mr-2" />
                  Book New Order
                </Button>
      ...
      <ScrollBannerSection
        isAuthenticated={isAuthenticated}
        onGalleryVisible={handleGalleryVisible}
      />
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-2xl font-bold">Kita Laundry</span>
              </div>
            ...
            <div>
              ...
              <div className="space-y-3 text-gray-400">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span>support@Kita Laundry.com</span>
                </div>
                <div className="flex items-center space-x-2">
                  <MapPin className="w-4 h-4" />
                  <span>
                    Available in{" "}
                    {stats ? `${stats.overview.totalCities}+` : "20+"} Cities
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>
              &copy; 2024 Kita Laundry. All rights reserved. | Privacy Policy |
              Terms of Service
            </p>
          </div>
        </div>
